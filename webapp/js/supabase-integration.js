...
(function() {
    ...
    const SupabaseIntegration = {
        ...
        init: function() {
            const supabaseUrl = 'https://rqsgxoepzazztmhxabxm.supabase.co';
            const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJxc2d4b2VwemF6enRtaHhhYnhtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjU1MDg3ODksImV4cCI6MjA4MTA4NDc4OX0.UdtVQ9e0Bi8cAVuXIe_P8U4WfQJejgTkKxcDsoUatIA';
